...
public class InspectionDue extends AppCompatActivity {
    
    private static final String TAG = "InspectionDue";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inspection_due_layout);
        initializeThreading();
    ...
    private void processAssetData() {
        ...
        for (int i = 0; i < assetsRequiringInspectionIds.size(); i++) {
            assetsRequiringInspectionStatus.add("Yellow");
        }
        Log.d(TAG, "Processing " + assetsRequiringInspectionIds.size() + " inspection due assets");
    ...
    private void sortList() {
        ...
        List<InspectionDueEntity> entities = new ArrayList<>(size);
        for (int i = 0; i < size; i++) {
            entities.add(new InspectionDueEntity(
        ...
        for (InspectionDueEntity entity : entities) {
    ...
    static class InspectionDueEntity implements Comparable<InspectionDueEntity> {
        final String name;
        final String nri;
        final String nte;
        final int id;
        
        InspectionDueEntity(String name, String nri, String nte, int id) {
            this.name = name;
            this.nri = nri;
            this.nte = nte;
            this.id = id;
        ...
        @Override
        public int compareTo(@NonNull InspectionDueEntity other) {
    ...
    private void navigateToAssetDetails(int position) {
        Intent intent = new Intent(InspectionDue.this, AssetDetails.class);
