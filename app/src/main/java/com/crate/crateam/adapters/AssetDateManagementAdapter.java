...
public class AssetDateManagementAdapter extends RecyclerView.Adapter<ViewHolder>{
    ...
    public AssetDateManagementAdapter(Context context,ArrayList<String>  assetRegimeLists,ArrayList<String> arraylist_regime_element_value) {
    ...
    public MainListItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.asset_date_management_list_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        mainListItem.tv_regime_element_name.setText(assetRegimeLists.get(position));
        mainListItem.tv_date.setText(arraylist_regime_element_value.get(position));
    }
    ...
    public int getItemCount() {
     ...
     public class MainListItem extends ViewHolder {
         ...
         private ImageView iv_view_date;
        public MainListItem(View itemView,final OnViewClickListener listener) {
            ...
            iv_view_date= itemView.findViewById(R.id.iv_view_date);
            iv_view_date.setOnClickListener(new View.OnClickListener() {
                @Override
