...
public class ViewInspectionRegimeAdapter extends RecyclerView.Adapter<ViewHolder>{

    ArrayList<String> assetRegimeLists;
    ArrayList<String> arraylist_regime_element_value;
    ArrayList<String> arraylist_regime_element_value_wm;

    public ViewInspectionRegimeAdapter(ArrayList<String>  assetRegimeLists,
                                       ArrayList<String> arraylist_regime_element_value,ArrayList<String> arraylist_regime_element_value_wm) {
        this.assetRegimeLists = assetRegimeLists;
        this.arraylist_regime_element_value = arraylist_regime_element_value;
        this.arraylist_regime_element_value_wm = arraylist_regime_element_value_wm;
    }
