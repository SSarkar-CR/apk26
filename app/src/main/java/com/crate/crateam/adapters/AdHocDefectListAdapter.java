...
public class AdHocDefectListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdHocDefectListAdapter(List<String> defectedVehicleList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adhoc_defect_row, parent, false);
    ...
    private static class DefectsListItem extends RecyclerView.ViewHolder {
        ...
        private DefectsListItem(View itemView,final OnCameraClickListener listener) {
            ...
            tv_defects = itemView.findViewById(R.id.tv_defects);
