...
public class AllAssetsAdapter extends RecyclerView.Adapter<ViewHolder>{
    ...
    public AllAssetsAdapter(Context context, ArrayList<Integer>  assetIds, ArrayList<String> assetNames,
    ...
    public MainListItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_assets_list_row, parent, false);
    ...
    public int getItemCount() {
     ...
     public class MainListItem extends ViewHolder {
        ...
        private LinearLayout ll_buttons,ll_inspection;
        private Button bt_inspect_asset;
