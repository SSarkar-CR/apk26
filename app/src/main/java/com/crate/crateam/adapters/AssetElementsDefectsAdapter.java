...
public class AssetElementsDefectsAdapter extends RecyclerView.Adapter<ViewHolder>{
    ...
    public AssetElementsDefectsAdapter(Context context,ArrayList<String> assetElementsLists) {
